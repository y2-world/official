    ...
    <div class="element js-fadein">
        <div class="container">
            ...
            <div class="album-wrapper">
                ...
                <div class="single">
                    <img src={{ asset('images/album_image3.jpg') }} class="album-image" id="album3">
                ...
                <div class="single">
                    <img src={{ asset('images/album_image2.jpg') }} class="album-image" id="album2">
                ...
                <div class="single">
                    <img src={{ asset('images/album_image1.jpg') }} class="album-image" id="album1">
