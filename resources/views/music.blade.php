    ...
    <div class="mt-4"></div>
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <a href="https://open.spotify.com/artist/5x6TjqB9xXXjY4Xn5y2oJm?si=9VNxfjcYQAKBiN3Q9q_lgg"><img src={{ asset('images/Spotify_Icon_RGB_Black.eps') }} class="image" width="7%"></a>
                <hr>
            </div>
        </div>
</div>
